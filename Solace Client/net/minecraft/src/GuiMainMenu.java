...
public class GuiMainMenu extends GuiScreen {
    ...
    public void initGui() {
        ...
        if (this.mc.hideQuitButton) {
            this.buttonList.add(new GuiButton(0, this.width / 2 - 100,
                    var4 + 72, var2.translateKey("menu.options")));
        } else {
            this.buttonList.add(new GuiButton(0, this.width / 2 - 100,
                    var4 + 72 + 12, 98, 20, var2.translateKey("menu.options")));
            this.buttonList.add(new GuiButton(4, this.width / 2 + 2,
                    var4 + 72 + 12, 98, 20, var2.translateKey("menu.quit")));
        }
        ...
        if ("ppc".equalsIgnoreCase(var5)) {
            this.field_92025_p = "" + EnumChatFormatting.BOLD + "Notice!"
    ...
    private void func_96137_a(StringTranslate par1StringTranslate, int par2,
                              int par3) {
        if (this.field_96141_q) {
            if (!field_96140_r) {
                field_96140_r = true;
                (new ThreadTitleScreen(this, par1StringTranslate, par2, par3))
                        .start();
    ...
    private void func_98060_b(StringTranslate par1StringTranslate, int par2,
                              int par3) {
        this.buttonList.add(new GuiButton(3, this.width / 2 - 100, par2 + par3
                * 2, par1StringTranslate.translateKey("menu.online")));
    }
    ...
    private void addSingleplayerMultiplayerButtons(int par1, int par2,
        ...
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, par1,
                par3StringTranslate.translateKey("menu.singleplayer")));
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, par1 + par2
                * 1, par3StringTranslate.translateKey("menu.multiplayer")));
        buttonList.add(new GuiButton(6, width / 2 - 100, par1 + par2 * 2,
                "Alt Manager"));
    }
    ...
    private void addDemoButtons(int par1, int par2,
                                StringTranslate par3StringTranslate) {
        this.buttonList.add(new GuiButton(11, this.width / 2 - 100, par1,
                par3StringTranslate.translateKey("menu.playdemo")));
        this.buttonList.add(this.buttonResetDemo = new GuiButton(12,
                this.width / 2 - 100, par1 + par2 * 1, par3StringTranslate
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        if ((double) this.updateCounter < 1.0E-4D) {
            ...
            this.drawTexturedModalRect(var6 + 99 + 26 + 3, var7 + 0, 99, 0, 26,
                    44);
        ...
        this.drawString(this.fontRenderer, var10, this.width
                - this.fontRenderer.getStringWidth(var10) - 2,
        ...
        if (this.field_92025_p != null && this.field_92025_p.length() > 0) {
            ...
            this.drawString(this.fontRenderer, field_96138_a,
    ...
    static void func_98061_a(GuiMainMenu par0GuiMainMenu,
                             StringTranslate par1StringTranslate, int par2, int par3) {
