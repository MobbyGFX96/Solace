...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float par1, boolean par2, int par3, int par4) {
		ScaledResolution var5 = new ScaledResolution(this.mc.gameSettings,
		...
		if (Minecraft.isFancyGraphicsEnabled()) {
			this.renderVignette(this.mc.thePlayer.getBrightness(par1), var6,
					var7);
		} else {
		...
		if (!this.mc.playerController.enableEverythingIsScrewedUpMode()) {
			...
			this.drawTexturedModalRect(var6 / 2 - 91 - 1 + var31.currentItem
					* 20, var7 - 22 - 1, 0, 22, 24, 22);
			...
			if (this.mc.playerController.shouldDrawHUD()) {
				...
				if (var20 > 0) {
					...
					if (var22 > 0) {
						this.drawTexturedModalRect(var18, var23, 0, 69, var22,
								5);
					}
				}
				...
				for (var25 = 0; var25 < 10; ++var25) {
					if (var23 > 0) {
						...
						if (var25 * 2 + 1 < var23) {
							this.drawTexturedModalRect(var26, var22, 34, 9, 9,
									9);
						}

						if (var25 * 2 + 1 == var23) {
							this.drawTexturedModalRect(var26, var22, 25, 9, 9,
									9);
						}

						if (var25 * 2 + 1 > var23) {
							this.drawTexturedModalRect(var26, var22, 16, 9, 9,
									9);
						}
					}
					...
					this.drawTexturedModalRect(var28, var29, 16 + var27 * 9,
							9 * var30, 9, 9);

					if (var11) {
						if (var25 * 2 + 1 < var13) {
							this.drawTexturedModalRect(var28, var29,
									var26 + 54, 9 * var30, 9, 9);
						}

						if (var25 * 2 + 1 == var13) {
							this.drawTexturedModalRect(var28, var29,
									var26 + 63, 9 * var30, 9, 9);
						}
					}

					if (var25 * 2 + 1 < var12) {
						this.drawTexturedModalRect(var28, var29, var26 + 36,
								9 * var30, 9, 9);
					}

					if (var25 * 2 + 1 == var12) {
						this.drawTexturedModalRect(var28, var29, var26 + 45,
								9 * var30, 9, 9);
					}
				}
				...
				for (var25 = 0; var25 < 10; ++var25) {
					...
					this.drawTexturedModalRect(var29, var26, 16 + var51 * 9,
							27, 9, 9);

					if (var14) {
						if (var25 * 2 + 1 < var17) {
							this.drawTexturedModalRect(var29, var26,
									var50 + 54, 27, 9, 9);
						}
					...
					if (var25 * 2 + 1 < var16) {
						this.drawTexturedModalRect(var29, var26, var50 + 36,
								27, 9, 9);
					}

					if (var25 * 2 + 1 == var16) {
						this.drawTexturedModalRect(var29, var26, var50 + 45,
								27, 9, 9);
					}
				}
				...
				if (this.mc.thePlayer.isInsideOfMaterial(Material.water)) {
					...
					var26 = MathHelper
							.ceiling_double_int((double) (var25 - 2) * 10.0D / 300.0D);
					var50 = MathHelper
							.ceiling_double_int((double) var25 * 10.0D / 300.0D)
							- var26;

					for (var28 = 0; var28 < var26 + var50; ++var28) {
						if (var28 < var26) {
							this.drawTexturedModalRect(var19 - var28 * 8 - 9,
									var22, 16, 18, 9, 9);
						} else {
							this.drawTexturedModalRect(var19 - var28 * 8 - 9,
									var22, 25, 18, 9, 9);
		...
		if (this.mc.playerController.func_78763_f()
				&& this.mc.thePlayer.experienceLevel > 0) {
		...
		if (this.mc.gameSettings.heldItemTooltips) {
			...
			if (this.field_92017_k > 0 && this.field_92016_l != null) {
				...
				if (var38 > 0) {
					...
					var8.drawStringWithShadow(var35, var12, var13,
							16777215 + (var38 << 24));
					GL11.glDisable(GL11.GL_BLEND);
					GL11.glPopMatrix();
				}
		...
		if (this.mc.isDemo()) {
			...
			if (this.mc.theWorld.getTotalWorldTime() >= 120500L) {
				...
				var35 = String
						.format(StatCollector
								.translateToLocal("demo.remainingTime"),
								new Object[] { StringUtils
										.ticksToElapsedTime((int) (120500L - this.mc.theWorld
												.getTotalWorldTime())) });
			}
		...
		if (this.mc.gameSettings.showDebugInfo) {
			...
			var8.drawStringWithShadow(
					"Minecraft 1.5.1 (" + this.mc.debug + ")", 2, 2, 16777215);
			var8.drawStringWithShadow(this.mc.debugInfoRenders(), 2, 12,
					16777215);
			var8.drawStringWithShadow(this.mc.getEntityDebug(), 2, 22, 16777215);
			var8.drawStringWithShadow(this.mc.debugInfoEntities(), 2, 32,
					16777215);
			var8.drawStringWithShadow(this.mc.getWorldProviderName(), 2, 42,
					16777215);
			...
			String var46 = "Used memory: " + var44 * 100L / var36 + "% ("
					+ var44 / 1024L / 1024L + "MB) of " + var36 / 1024L / 1024L
					+ "MB";
			this.drawString(var8, var46, var6 - var8.getStringWidth(var46) - 2,
					2, 14737632);
			var46 = "Allocated memory: " + var40 * 100L / var36 + "% (" + var40
					/ 1024L / 1024L + "MB)";
			this.drawString(var8, var46, var6 - var8.getStringWidth(var46) - 2,
					12, 14737632);
			...
			this.drawString(
					...
					String.format(
							"x: %.5f (%d) // c: %d (%d)",
							new Object[] {
									Double.valueOf(this.mc.thePlayer.posX),
									Integer.valueOf(var47),
									Integer.valueOf(var47 >> 4),
									Integer.valueOf(var47 & 15) }), 2, 64,
					14737632);
			this.drawString(var8, String.format(
					"y: %.3f (feet pos, %.3f eyes pos)",
					new Object[] {
							Double.valueOf(this.mc.thePlayer.boundingBox.minY),
							Double.valueOf(this.mc.thePlayer.posY) }), 2, 72,
					14737632);
			this.drawString(
					var8,
					String.format(
							"z: %.5f (%d) // c: %d (%d)",
							new Object[] {
									Double.valueOf(this.mc.thePlayer.posZ),
									Integer.valueOf(var23),
									Integer.valueOf(var23 >> 4),
									Integer.valueOf(var23 & 15) }), 2, 80,
					14737632);
			var24 = MathHelper
			...
			if (this.mc.theWorld != null
					&& this.mc.theWorld.blockExists(var47, var22, var23)) {
				Chunk var52 = this.mc.theWorld.getChunkFromBlockCoords(var47,
						var23);
				this.drawString(
						var8,
						"lc: "
								+ (var52.getTopFilledSegment() + 15)
								+ " b: "
								+ var52.getBiomeGenForWorldCoords(var47 & 15,
										var23 & 15,
										this.mc.theWorld.getWorldChunkManager()).biomeName
								+ " bl: "
								+ var52.getSavedLightValue(EnumSkyBlock.Block,
										var47 & 15, var22, var23 & 15)
								+ " sl: "
								+ var52.getSavedLightValue(EnumSkyBlock.Sky,
										var47 & 15, var22, var23 & 15)
								+ " rl: "
								+ var52.getBlockLightValue(var47 & 15, var22,
										var23 & 15, 0), 2, 96, 14737632);
			}

			this.drawString(var8, String.format(
					"ws: %.3f, fs: %.3f, g: %b, fl: %d",
					new Object[] {
							Float.valueOf(this.mc.thePlayer.capabilities
									.getWalkSpeed()),
							Float.valueOf(this.mc.thePlayer.capabilities
									.getFlySpeed()),
							Boolean.valueOf(this.mc.thePlayer.onGround),
							Integer.valueOf(this.mc.theWorld.getHeightValue(
		...
		if (this.recordPlayingUpFor > 0) {
			...
			if (var12 > 0) {
				...
				var8.drawString(this.recordPlaying,
						-var8.getStringWidth(this.recordPlaying) / 2, -4, var13
								+ (var12 << 24));
				GL11.glDisable(GL11.GL_BLEND);
				GL11.glPopMatrix();
			}
		...
		if (this.mc.gameSettings.keyBindPlayerList.pressed
				&& (!this.mc.isIntegratedServerRunning()
						|| this.mc.thePlayer.sendQueue.playerInfoList.size() > 1 || var42 != null)) {
			...
			byte var45 = 10;
			drawRect(var18 - 1, var45 - 1, var18 + var17 * var16, var45 + 9
			...
			for (var20 = 0; var20 < var38; ++var20) {
				...
				if (var20 < var41.size()) {
					...
					ScorePlayerTeam var48 = this.mc.theWorld.getScoreboard()
							.func_96509_i(var49.name);
					String var53 = ScorePlayerTeam.func_96667_a(var48,
							var49.name);
					...
					if (var42 != null) {
						...
						if (var50 - var26 > 5) {
							Score var56 = var42.func_96682_a().func_96529_a(
									var49.name, var42);
							String var57 = EnumChatFormatting.YELLOW + ""
									+ var56.func_96652_c();
							var8.drawStringWithShadow(var57,
									var50 - var8.getStringWidth(var57), var22,
									16777215);
						}
					}
					...
					this.zLevel += 100.0F;
					this.drawTexturedModalRect(var47 + var17 - 12, var22,
							0 + var55 * 10, 176 + var27 * 8, 10, 8);
					this.zLevel -= 100.0F;
				}
			}
		}
	...
	private void func_96136_a(ScoreObjective par1ScoreObjective, int par2,
			int par3, FontRenderer par4FontRenderer) {
		Scoreboard var5 = par1ScoreObjective.func_96682_a();
		Collection var6 = var5.func_96534_i(par1ScoreObjective);

		if (var6.size() <= 15) {
			int var7 = par4FontRenderer.getStringWidth(par1ScoreObjective
					.func_96678_d());
			String var11;

			for (Iterator var8 = var6.iterator(); var8.hasNext(); var7 = Math
					.max(var7, par4FontRenderer.getStringWidth(var11))) {
				Score var9 = (Score) var8.next();
				ScorePlayerTeam var10 = var5.func_96509_i(var9.func_96653_e());
				var11 = ScorePlayerTeam
						.func_96667_a(var10, var9.func_96653_e())
						+ ": "
						+ EnumChatFormatting.RED + var9.func_96652_c();
			}
			...
			while (var13.hasNext()) {
				...
				String var16 = ScorePlayerTeam.func_96667_a(var15,
						var14.func_96653_e());
				String var17 = EnumChatFormatting.RED + ""
						+ var14.func_96652_c();
				int var19 = var23 - var12 * par4FontRenderer.FONT_HEIGHT;
				int var20 = par3 - var25 + 2;
				drawRect(var24 - 2, var19, var20, var19
						+ par4FontRenderer.FONT_HEIGHT, 1342177280);
				par4FontRenderer.drawString(var16, var24, var19, 553648127);
				par4FontRenderer.drawString(var17,
						var20 - par4FontRenderer.getStringWidth(var17), var19,
						553648127);

				if (var12 == var6.size()) {
					String var21 = par1ScoreObjective.func_96678_d();
					drawRect(var24 - 2, var19 - par4FontRenderer.FONT_HEIGHT
							- 1, var20, var19 - 1, 1610612736);
					drawRect(var24 - 2, var19 - 1, var20, var19, 1342177280);
					par4FontRenderer.drawString(var21, var24 + var7 / 2
							- par4FontRenderer.getStringWidth(var21) / 2, var19
							- par4FontRenderer.FONT_HEIGHT, 553648127);
				}
			}
		}
	}
	...
	private void renderBossHealth() {
		if (BossStatus.bossName != null && BossStatus.statusBarLength > 0) {
			...
			ScaledResolution var2 = new ScaledResolution(this.mc.gameSettings,
					this.mc.displayWidth, this.mc.displayHeight);
	...
	private void renderVignette(float par1, int par2, int par3) {
		...
		GL11.glColor4f(this.prevVignetteBrightness,
				this.prevVignetteBrightness, this.prevVignetteBrightness, 1.0F);
	...
	private void renderPortalOverlay(float par1, int par2, int par3) {
		...
		var9.addVertexWithUV(0.0D, (double) par3, -90.0D, (double) var5,
				(double) var8);
		var9.addVertexWithUV((double) par2, (double) par3, -90.0D,
				(double) var7, (double) var8);
		var9.addVertexWithUV((double) par2, 0.0D, -90.0D, (double) var7,
				(double) var6);
	...
	private void renderInventorySlot(int par1, int par2, int par3, float par4) {
		...
		if (var5 != null) {
			...
			itemRenderer.renderItemAndEffectIntoGUI(this.mc.fontRenderer,
					this.mc.renderEngine, var5, par2, par3);
		...
		if (this.mc.thePlayer != null) {
			...
			if (var1 == null) {
				this.field_92017_k = 0;
					...
					&& var1.itemID == this.field_92016_l.itemID
					&& ItemStack
							.areItemStackTagsEqual(var1, this.field_92016_l)
					&& (var1.isItemStackDamageable() || var1.getItemDamage() == this.field_92016_l
							.getItemDamage())) {
