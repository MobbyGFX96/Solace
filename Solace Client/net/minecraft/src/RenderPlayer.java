...
public class RenderPlayer extends RenderLiving {
    ...
    protected void func_98191_a(EntityPlayer par1EntityPlayer) {
        this.loadDownloadableImageTexture(par1EntityPlayer.skinUrl,
    ...
    protected int setArmorModel(EntityPlayer par1EntityPlayer, int par2,
        ...
        if (var4 != null) {
            ...
            if (var5 instanceof ItemArmor) {
                ...
                this.loadTexture("/armor/"
                        + armorFilenamePrefix[var6.renderIndex] + "_"
                        + (par2 == 2 ? 2 : 1) + ".png");
                ModelBiped var7 = par2 == 2 ? this.modelArmor
    ...
    protected void func_82439_b(EntityPlayer par1EntityPlayer, int par2,
                                float par3) {
        ItemStack var4 = par1EntityPlayer.inventory.armorItemInSlot(3 - par2);
    ...
    public void renderPlayer(EntityPlayer par1EntityPlayer, double par2,
        ...
        this.modelArmorChestplate.heldItemRight = this.modelArmor.heldItemRight = this.modelBipedMain.heldItemRight = var11 != null ? 1
                : 0;
    ...
    protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2) {
        ...
        if (var4 != null) {
            ...
            if (var4.getItem().itemID < 256) {
                ...
                this.renderManager.itemRenderer.renderItem(par1EntityPlayer,
                        var4, 0);
        ...
        if (this.loadDownloadableImageTexture(par1EntityPlayer.cloakUrl,
                (String) null)
            ...
            var11 = par1EntityPlayer.prevRenderYawOffset
                    ...
                    * par2;
            double var12 = (double) MathHelper.sin(var11 * (float) Math.PI
                    / 180.0F);
            double var14 = (double) (-MathHelper.cos(var11 * (float) Math.PI
                    / 180.0F));
            ...
            float var19 = par1EntityPlayer.prevCameraYaw
        ...
        if (var21 != null) {
            ...
            if (var21.getItem().requiresMultipleRenderPasses()) {
                for (var27 = 0; var27 <= 1; ++var27) {
                    int var26 = var21.getItem().getColorFromItemStack(var21,
                            var27);
    ...
    protected void func_96450_a(EntityPlayer par1EntityPlayer, double par2,
        ...
        if (par10 < 100.0D) {
            ...
            if (var13 != null) {
                Score var14 = var12.func_96529_a(
                        par1EntityPlayer.getEntityName(), var13);

                if (par1EntityPlayer.isPlayerSleeping()) {
                    this.renderLivingLabel(par1EntityPlayer,
                            var14.func_96652_c() + " " + var13.func_96678_d(),
                            par2, par4 - 1.5D, par6, 64);
                } else {
                    this.renderLivingLabel(par1EntityPlayer,
                            var14.func_96652_c() + " " + var13.func_96678_d(),
                            par2, par4, par6, 64);
    ...
    protected void renderPlayerSleep(EntityPlayer par1EntityPlayer,
        ...
        if (par1EntityPlayer.isEntityAlive()
            ...
            super.renderLivingAt(par1EntityPlayer, par2
                    + (double) par1EntityPlayer.field_71079_bU, par4
                    + (double) par1EntityPlayer.field_71082_cx, par6
    ...
    protected void rotatePlayer(EntityPlayer par1EntityPlayer, float par2,
        ...
        if (par1EntityPlayer.isEntityAlive()
            ...
            GL11.glRotatef(par1EntityPlayer.getBedOrientationInDegrees(), 0.0F,
                    1.0F, 0.0F);
            GL11.glRotatef(this.getDeathMaxRotation(par1EntityPlayer), 0.0F,
                    0.0F, 1.0F);
    ...
    protected void func_96449_a(EntityLiving par1EntityLiving, double par2,
                                double par4, double par6, String par8Str, float par9, double par10) {
        this.func_96450_a((EntityPlayer) par1EntityLiving, par2, par4, par6,
                par8Str, par9, par10);
    }
    ...
    protected void renderLivingAt(EntityLiving par1EntityLiving, double par2,
        ...
        this.renderPlayerSleep((EntityPlayer) par1EntityLiving, par2, par4,
                par6);
    }
    ...
    public void doRenderLiving(EntityLiving par1EntityLiving, double par2,
                               double par4, double par6, float par8, float par9) {
        this.renderPlayer((EntityPlayer) par1EntityLiving, par2, par4, par6,
                par8, par9);
    }
    ...
    public void doRender(Entity par1Entity, double par2, double par4,
        ...
        this.renderPlayer((EntityPlayer) par1Entity, par2, par4, par6, par8,
                par9);
    }
}
